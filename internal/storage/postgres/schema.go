...
// schema contains the DDL statements to initialise the PostgreSQL schema.
// CREATE TABLE IF NOT EXISTS / CREATE INDEX IF NOT EXISTS are idempotent so
// calling migrate on every open is safe.
const schema = `
